...
public class NewBusSearchList extends ArrayAdapter<BusTransferSearch> {
    ...
    public NewBusSearchList(Context context, ArrayList<BusTransferSearch> busSearchs) {
...
//		setNextTime();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.advanced_new_search_result_list, parent, false);
        }
        BusTransferSearch item = getItem(position);
